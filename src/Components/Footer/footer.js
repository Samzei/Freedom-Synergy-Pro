    ...
    return (
        <div style={{background: '#353a3d'}}>
            <div className='mh7 pv5 flex near-white'>
                ...
                <div className='w-30 no-underline'>
                    <p className='mb3 f3 b'>Pages</p>
                    <div className='mb3'><NavLink to="/"><span className='near-white'>Home</span></NavLink></div>
                    <div className='mb3'><NavLink to="/about"><span className='mid-gray hover-near-white'>About</span></NavLink></div>
                    <div  className='mb3'><NavLink to="/services"><span className='mid-gray hover-near-white'>Services</span></NavLink></div>
                    <div className='mb3'><NavLink to="/contact"><span className='mid-gray hover-near-white'>Contact</span></NavLink></div>
                </div>
                <div className=''>
